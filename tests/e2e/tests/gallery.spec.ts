// The two gallery routes. They mount no AppShell, open no socket and name no patch, which is
// what lets this project run fullyParallel.

import { test, expect } from '@playwright/test';
import { installInkProbe } from '../lib/ink';
import { exportedPrimitives, SAMPLES } from '../lib/uiSweep';

test.describe('the primitive gallery', () => {
...
test.describe('the inspector gallery', () => {
